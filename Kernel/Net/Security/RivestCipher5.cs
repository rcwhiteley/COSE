...
namespace Kernel.Net.Security
{
    ...
    /// </summary>
    public class RivestCipher5 : IDecoder, IEncoder
    {
        private static readonly byte[] defaultSeed = { 0x3C, 0xDC, 0xFE, 0xE8, 0xC4, 0x54, 0xD6, 0x7E, 0x16, 0xA6, 0xF8, 0x1A, 0xE8, 0xD0, 0x38, 0xBE };
        ...
        /// </summary>
        public unsafe RivestCipher5(Byte[] aSeed = null)
        {
            if (aSeed == null) aSeed = defaultSeed;
        ...
        /// </summary>
        public unsafe void Encode(Span<byte> aBuf)
        {
            if (aBuf.Length % 8 != 0)
            ...
            fixed (Byte* buf = aBuf)
            {
                ...
                for (Int32 k = 0, len = aBuf.Length / 8; k < len; ++k)
                {
        ...
        /// </summary>
        public unsafe void Decode(Span<byte> aBuf)
        {
            if (aBuf.Length % 8 != 0)
                throw new ArgumentException("Length of the buffer must be a multiple of 64 bits.", "aLength");
